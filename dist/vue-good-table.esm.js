...
var script$3 = {
  ...
  computed: {
    hasFilterRow: function hasFilterRow() {
      console.log('OPAAAAA', this.column);
  ...
  methods: {
    ...
    getPlaceholder: function getPlaceholder(column) {
      return this.isFilterable(column) && column.filterOptions.placeholder || "Filter ".concat(column.label);
    },
    ...
    populateInitialFilters: function populateInitialFilters() {
      if (this.isFilterable(this.column) && typeof this.column.filterOptions.filterValue !== 'undefined' && this.column.filterOptions.filterValue !== null) {
...
var __vue_render__$3 = function __vue_render__() {
  ...
  return !_vm.column.hidden && _vm.hasFilterRow && _vm.isFilterable(_vm.column) ? _c('div', [!_vm.isDropdown(_vm.column) ? _c('input', {
    ...
    domProps: {
      "value": _vm.columnFilters[_vm.column.field]
    },
    on: {
      "keyup": function keyup($event) {
        if (!$event.type.indexOf('key') && _vm._k($event.keyCode, "enter", 13, $event.key, "Enter")) {
        ...
        return _vm.updateFiltersOnEnter(_vm.column, $event.target.value);
      },
      "input": function input($event) {
        return _vm.updateFiltersOnKeyup(_vm.column, $event.target.value);
      }
    }
  }) : _vm._e(), _vm._v(" "), _vm.isDropdownArray(_vm.column) ? _c('select', {
    ...
    on: {
      "change": function change($event) {
        return _vm.updateFilters(_vm.column, $event.target.value);
      }
    }
  }, [_c('option', {
    key: "-1",
  ...
  }, [_vm._v(_vm._s(_vm.getPlaceholder(_vm.column)))]), _vm._v(" "), _vm._l(_vm.column.filterOptions.filterDropdownItems, function (option, i) {
    return _c('option', {
      key: i,
      domProps: {
        "value": option
  ...
  })], 2) : _vm._e(), _vm._v(" "), _vm.isDropdownObjects(_vm.column) ? _c('select', {
    staticClass: "vgt-select",
    domProps: {
      "value": _vm.columnFilters[_vm.column.field]
    },
    on: {
      "change": function change($event) {
        return _vm.updateFilters(_vm.column, $event.target.value, true);
      }
    }
  }, [_c('option', {
    key: "-1",
...
var __vue_scope_id__$3 = "data-v-188e04a6";
/* module identifier */
...
var __vue_scope_id__$4 = "data-v-30eaa9de";
/* module identifier */
